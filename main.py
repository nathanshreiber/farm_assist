...
#first floor node initialization
	node_1 = node(node_1,None,None)
	node_2 = node(node_2,None,None)
	node_3 = node(node_3,None,None)
	node_4 = node(node_4,None,None)
	node_5 = node(node_5,None,None)
	node_6 = node(node_6,None,None)
	node_7 = node(node_7,None,None)
	node_8 = node(node_8,None,None)
	node_9 = node(node_9,None,None)
	node_10 = node(node_10,None,None)
	node_11 = node(node_11,None,None)
	node_12 = node(node_12,None,None)
	node_13 = node(node_13,None,None)
	node_14 = node(node_14,None,None)
	node_15 = node(node_15,None,None)
	node_16 = node(node_16,None,None)
	node_17 = node(node_17,None,None)
	node_18 = node(node_18,None,None)
	node_19 = node(node_19,None,None)
	node_20 = node(node_20,None,None)
	node_21 = node(node_21,None,None)
	node_22 = node(node_22,None,None)
	node_23 = node(node_23,None,None)
	node_24 = node(node_24,None,None)
	node_25 = node(node_25,None,None)
	node_26 = node(node_26,None,None)
	node_27 = node(node_27,None,None)
	node_28 = node(node_28,None,None)
	node_29 = node(node_29,None,None)
	node_30 = node(node_30,None,None)
	node_31 = node(node_31,None,None)
	node_32 = node(node_32,None,None)
	node_33 = node(node_33,None,None)
	node_34 = node(node_34,None,None)
	node_35 = node(node_35,None,None)
	node_36 = node(node_36,None,None)
	node_37 = node(node_37,None,None)
	node_38 = node(node_38,None,None)
	node_39 = node(node_39,None,None)
	node_40 = node(node_40,None,None)
	node_41 = node(node_41,None,None)
	node_42 = node(node_42,None,None)
	node_43 = node(node_43,None,None)
	node_44 = node(node_44,None,None)
...
#second floor node initialization
	node_45 = node(node_45,None,None)
	node_46 = node(node_46,None,None)
	node_47 = node(node_47,None,None)
	node_48 = node(node_48,None,None)
	node_49 = node(node_49,None,None)
	node_50 = node(node_50,None,None)
	node_51 = node(node_51,None,None)
	node_52 = node(node_52,None,None)
	node_53 = node(node_53,None,None)
	node_54 = node(node_54,None,None)
	node_55 = node(node_55,None,None)
	node_56 = node(node_56,None,None)
	node_57 = node(node_57,None,None)
	node_58 = node(node_58,None,None)
	node_59 = node(node_59,None,None)
	node_60 = node(node_60,None,None)
	node_61 = node(node_61,None,None)
	node_62 = node(node_62,None,None)
	node_63 = node(node_63,None,None)
	node_64 = node(node_64,None,None)
	node_65 = node(node_65,None,None)
	node_66 = node(node_66,None,None)
	node_67 = node(node_67,None,None)
	node_68 = node(node_68,None,None)
	node_69 = node(node_69,None,None)
	node_70 = node(node_70,None,None)
	node_71 = node(node_71,None,None)
	node_72 = node(node_72,None,None)
	node_73 = node(node_73,None,None)
	node_74 = node(node_74,None,None)
	node_75 = node(node_75,None,None)
	node_76 = node(node_76,None,None)
	node_77 = node(node_77,None,None)
	node_78 = node(node_78,None,None)
	node_79 = node(node_79,None,None)
	node_80 = node(node_80,None,None)
	node_81 = node(node_81,None,None)
	node_82 = node(node_82,None,None)
	node_83 = node(node_83,None,None)
	node_84 = node(node_84,None,None)
